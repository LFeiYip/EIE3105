...
// this program is to move wheels repeatedly in every second
// 1st second: Left wheel moves forward
// 2nd second: Right wheel moves forward
// 3rd second: Left wheel moves backward
// 4th second: Right wheel moves backward
